...
<template>
    <AuthenticatedLayout>
        ...
        <InputError v-else-if="dashData?.isError.value" class="mt-2" :message="dashData?.failureReason?.value?.message" />
            ...
            <div class="bg-white bg-danger overflow-hidden shadow-sm sm:rounded-lg" style="display: flex;">
                <div class="row" style="padding: 20px; display: flex; gap: 10px; flex-direction: column; flex-grow: 1;">
                    <div style="display: flex;flex-direction: row;align-items: center;  gap: 10px;">
                        <a style="padding: 10px 20px; background: green; border-radius: 50px;" href="/payment">Transfer</a>
